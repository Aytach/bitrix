...
$arParams["LBLOCK_ID"] = intval($arParams["IBLOCK_ID"]);
$arParams["LBLOCKS_PROP"] = intval($arParams["IBLOCKS_PROP"]);
...
if($arParams['IBLOCK_ID'] > 0 && $arParams['IBLOCKS_PROP'] > 0 && $this->StartResultCache(false, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups())))
{
	...
	$arFilter = array(
		...
		"ACTIVE"=>"Y",
		"CHECK_PERMISSIONS"=>"Y",
		"!PROPERTY_".$arParams['IBLOCKS_PROP'] => false,// свойство с выбранным ID НЕ FALSE
	);
